    ...
    return (
      <div className="sm:px-16 xl:px-48">
        ...
        <div className="flex flex-col items-center">
            <Card title="Tic-Tac-Toe" href="/projects/tic-tac-toe" hrefText="view projct" description="Following the Tic-Tac-Toe tutorial from https://react.dev/learn/tutorial-tic-tac-toe" />
        </div>
      </div>
    );
}